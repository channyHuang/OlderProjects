...
int App_main(int argc, char** argv)
{
	...
	std::string pathDepthDir = "E:/depthMaps";
	...
	for (int i = 0; i < numImg; i += inc){
		...
		convertAhandaPovRayToStandard("E:/thirdLib/opendtam_cross_platform-master/build/Trajectory_30_seconds", i + offset,
			cameraMatrix,
			R,
			T);
		cout << "Reading: " << filename << endl;
		imread(filename, -1).convertTo(image, CV_32FC3, 1.0 / 65535, 1 / 255.0);
