...
namespace cv{
    namespace gpu{
        ...
        private:
			...
			Stream getStream(){ CV_Assert(!"Not Implemented"); return Stream::Null(); }
            
            void setAlpha(float alpha){CV_Assert(!"Not Implemented");}
			float getAlpha(){ CV_Assert(!"Not Implemented"); return 0.0f; }
            
            void setBeta(float beta){CV_Assert(!"Not Implemented");};
			float getBeta(){ CV_Assert(!"Not Implemented"); return 0.0f; }
